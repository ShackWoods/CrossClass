...
struct Line_Data_Node *append_line_data(struct Line_Data_Node *list,
...
bool line_data_node_equality(const struct Line_Data_Node *a,
                             const struct Line_Data_Node *b) {
